...
static func get_custom_textures(control_name: String, is_landscape: bool) -> Array:
	...
	var specific_normal = PicoBootManager.PUBLIC_FOLDER + "/" + control_name + suffix + ".png"
	var specific_pressed = PicoBootManager.PUBLIC_FOLDER + "/" + control_name + suffix + "_pressed.png"
	
	print("CustomControlTextures: Checking ", specific_normal)
	if FileAccess.file_exists(specific_normal):
		print("  -> Found!")
		...
		if FileAccess.file_exists(specific_pressed):
	...
	var generic_normal = PicoBootManager.PUBLIC_FOLDER + "/" + control_name + ".png"
	var generic_pressed = PicoBootManager.PUBLIC_FOLDER + "/" + control_name + "_pressed.png"
	
	if FileAccess.file_exists(generic_normal):
		...
		if FileAccess.file_exists(generic_pressed):
